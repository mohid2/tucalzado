    ...
    async function fetchCountries() {
        try {
            ...
            const response = await fetch('http://api.geonames.org/countryInfoJSON?username=mohammedelyousfi&lang=es');
    ...
    async function fetchCommunity() {
        try {
            ...
            const response = await fetch(`http://api.geonames.org/childrenJSON?geonameId=${selectedCountry}&username=mohammedelyousfi&lang=es`);
            const data = await response.json();
    ...
    async function fetchProvince() {
        try {
            ...
            const response = await fetch(`http://api.geonames.org/childrenJSON?geonameId=${selectedCommunity}&username=mohammedelyousfi&lang=es`);
            const data = await response.json();
    ...
    async function fetchCity() {
        try {
            ...
            const response = await fetch(`http://api.geonames.org/childrenJSON?geonameId=${selectedProvince}&username=mohammedelyousfi&lang=es`);
            const data = await response.json();
